namespace BashSoft.IO.Commands
{
    ...
    public class GetHelpCommand : Command, IExecutable
    {
        ...
        private void DisplayHelp()
        {
            ...
            sb.AppendLine(string.Format("|{0, -98}|", "display data entities - display students/courses asceding/descending"));
            sb.AppendLine(string.Format("|{0, -98}|", "   (For example: display students descending)"));
