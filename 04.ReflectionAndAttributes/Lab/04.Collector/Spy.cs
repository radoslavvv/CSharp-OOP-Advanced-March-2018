...
public class Spy
{
    ...
    public string CollectGettersAndSetters(string className)
    {
        ...
        foreach (var property in properties)
        {
            ...
            {
                result.AppendLine($"{property.GetMethod.Name} will return {property.GetMethod.ReturnType}");
            }
        }
        ...
        foreach (var property in properties)
        {
            ...
            {
                result.AppendLine($"{property.SetMethod.Name} will set field of {property.SetMethod.GetParameters().First().ParameterType}");
            }
        }
