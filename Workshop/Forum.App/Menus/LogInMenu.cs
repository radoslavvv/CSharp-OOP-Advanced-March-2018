namespace Forum.App.Menus
{
    ...
    public class LogInMenu : Menu
    {
        ...
        public LogInMenu(ILabelFactory labelFactory, ICommandFactory commandFactory, ISession session, IForumReader forumReader, IUserService userServise)
        {
        ...
        public override IMenu ExecuteCommand()
        {
            ...
            try
            {
                ...
                IMenu menuView = command.Execute(this.UsernameInput, this.PasswordInput);
